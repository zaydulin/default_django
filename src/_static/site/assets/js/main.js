        ...
        if (name != '' && email != '' && msg != '') {
          ...
          $.ajax({
            ...
            success: function () {
              ...
              $('#email').val('');
              $('#msg').val('');
              window.location.replace("https://softwaveocean.com/glamifybliss-multipage/thank-you.html");
            }
          });
        } else {
