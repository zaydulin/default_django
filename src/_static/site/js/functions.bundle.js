  ...
  (function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
      ...
      : "function" == typeof define && define.amd
        ? define(t)
        : ((e =
            "undefined" != typeof globalThis ? globalThis : e || self).CNVS =
            t());
  })(this, function () {
    "use strict";
          ...
          init: function (e) {
            ...
            ((N.getVars.stickyHeaderClasses =
              ...
              (N.getVars.resizers.headers = function () {
                setTimeout(function () {
                  (ne(),
                    t && (ie(), B(N.getVars.headerWrapOffset), P("sticky")),
                    P("responsive"),
                    re());
                }, 250);
              }));
                  ...
                  function (e) {
                    (e.target.closest(".primary-menu-trigger") ||
                      ...
                      e.target.closest(".primary-menu.on-click") ||
                        (t.forEach(function (e) {
                          e.querySelectorAll(".menu-item").forEach(
                            function (e) {
                              e.classList.remove("current");
                            },
                          );
        ...
        Cursor: {
          init: function (e) {
            ...
            (document.addEventListener("mousemove", function (e) {
              ...
              document
                .querySelectorAll(".cursor-disable")
                .forEach(function (e) {
                  (e.addEventListener("mouseenter", function () {
                      ...
                      (e?.some(function (e) {
                        ...
                        s != Number(c) &&
                          ...
                          t.classList.contains("fslider")
                            ...
                            : (t.innerHTML +=
                                '<li><i class="fa-brands fa-x-twitter"></i><div><span>' +
                                r +
            ...
            return (
              ...
              void e.forEach(function (e) {
                var t = {
                  ...
                  triggerType:
                    e.getAttribute("data-ajax-trigger-type") || "click",
                  loadDelay: e.getAttribute("data-ajax-load-delay") || 2222,
                  container: document.querySelector(
                    e.getAttribute("data-ajax-container"),
                  ),
                  contentPlacement:
                    e.getAttribute("data-ajax-insertion") || "append",
                  triggerHide:
                    e.getAttribute("data-ajax-trigger-hide") || "true",
                  triggerDisable:
                    e.getAttribute("data-ajax-trigger-disable") || "true",
              ...
              return (
                ...
                (t = N.getSelector(t, !1)).length < 1 ||
                  ...
                  document.querySelectorAll(".tab-hover").forEach(function (e) {
                    e.querySelectorAll("[data-bs-target]").forEach(
                      function (e) {
                        e.addEventListener("mouseenter", function () {
                          a(e);
                        });
    ...
    function R(i) {
      fetch(i.loader)
        ...
        .then(function (e) {
          ...
          ("append" == i.placement
            ? i.container?.insertAdjacentHTML("beforeend", t.body.innerHTML)
            : i.container?.insertAdjacentHTML("afterbegin", t.body.innerHTML),
        ...
        N.getVars.elPrimaryMenus.forEach(function (e) {
          (t.classList.contains("is-expanded-menu")
            ? (e
              ...
              N.getVars.elPrimaryMenus.forEach(function (e) {
                e.querySelectorAll(".mobile-primary-menu")?.forEach(
                  function (e) {
                    e.classList.remove("d-block");
                  },
                );
