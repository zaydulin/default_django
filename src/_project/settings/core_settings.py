...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'mail.works-all.ru', 'demomail.works-all.ru']
...
INSTALLED_APPS = [
    ...
    'apps.buhgalteris.apps.BuhgalterisConfig',
...
# Celery
CELERY_BROKER_URL = f'redis://{env.str("DJANGO_REDIS_HOST", "localhost")}:{env.str("DJANGO_REDIS_PORT", "6379")}/0'
