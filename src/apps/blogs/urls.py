...
urlpatterns = [
    ...
    path('moderation/articles-delete/<int:pk>/', views.BlogDeleteView.as_view(), name='articles_delete'),
    ...
    path('moderation/categories-delete/<int:pk>/', views.CategoriesDeleteView.as_view(), name='categories_delete'),
    ...
    path('moderation/tags-delete/<int:pk>/', views.TagsDeleteView.as_view(), name='tags_delete'),
